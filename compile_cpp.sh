...
/usr/bin/c++ "$OBJECT_FILE" -o "$BINARY_NAME" -L/usr/local/cuda/lib64 -Wl,-rpath,/usr/local/cuda/lib64: -Wl,-rpath,'$ORIGIN' -Wl,-rpath,'$ORIGIN/../lib64' -Wl,-rpath,'$ORIGIN/../lib' -Wl,-rpath,'/usr/local/cuda/lib64' -Wl,-rpath,'/usr/local/cuda/lib' /teamspace/studios/this_studio/cup/cutlass/build/lib/libgtest.a -Wl,-rpath,'$ORIGIN' -Wl,-rpath,'$ORIGIN/../lib64' -Wl,-rpath,'$ORIGIN/../lib' -Wl,-rpath,'/usr/local/cuda/lib64' -Wl,-rpath,'/usr/local/cuda/lib' -lpthread
rm "$OBJECT_FILE"
