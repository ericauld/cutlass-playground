...
/usr/local/cuda/bin/nvcc -forward-unknown-to-host-compiler --options-file /teamspace/studios/this_studio/a/cutlass/build/examples/cute/tutorial/CMakeFiles/sgemm_1.dir/includes_CUDA.rsp -DCUTLASS_VERSIONS_GENERATED -O3 -DNDEBUG -std=c++17 "--generate-code=arch=compute_75,code=[sm_75]"  -Xcompiler=-fPIE -DCUTLASS_ENABLE_TENSOR_CORE_MMA=1 --expt-relaxed-constexpr -DCUTLASS_TEST_LEVEL=0 -DCUTLASS_TEST_ENABLE_CACHED_RESULTS=1 -DCUTLASS_CONV_UNIT_TEST_RIGOROUS_SIZE_ENABLED=1 -DCUTLASS_DEBUG_TRACE_LEVEL=0 -Xcompiler=-Wconversion -Xcompiler=-fno-strict-aliasing -x cu -c "$SOURCE_FILE" -o "$OBJECT_FILE"
